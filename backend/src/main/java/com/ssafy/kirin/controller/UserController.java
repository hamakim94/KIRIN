...
public class UserController {
    ...
    public ResponseEntity userProfileEdit(@ApiIgnore @AuthenticationPrincipal UserDTO user, @RequestPart(value = "profileImg", required = false) MultipartFile profileImg, @RequestPart(value = "userDTO") UserDTO userDTO){
