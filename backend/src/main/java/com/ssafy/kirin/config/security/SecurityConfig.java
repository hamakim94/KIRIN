...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_API_URI = {
            "/api/notify/**", "/api/users/signup", "/api/users/login", "/api/users/reissue", "/api/users/duplications/check", "/api/users/confirm-email", "/api/users/find-password", "/api/users/check-duplicate/**"
    };
