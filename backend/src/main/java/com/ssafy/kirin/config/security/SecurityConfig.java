...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_API_URI = {
            "/api/notify/**","/api/challenges","/api/users/signup", "/api/users/login", "/api/users/reissue", "/api/users/duplications/check", "/api/users/confirm-email", "/api/users/check-duplicate/**"
    };
